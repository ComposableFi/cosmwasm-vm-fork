...
export interface InitOutput {
  ...
  readonly vm_instantiate: (a: number, b: number, c: number, d: number, e: number) => number;
  readonly vm_execute: (a: number, b: number, c: number, d: number, e: number) => number;
  readonly vm_migrate: (a: number, b: number, c: number, d: number, e: number) => number;
  readonly vm_continue_instantiate: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
  readonly vm_continue_execute: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
  readonly vm_continue_migrate: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
